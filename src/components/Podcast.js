    ...
    <div id="podcast" className="podcast">
      <div className="podcast_text">
        ...
        <p className="podcast_para">
          ...
          members. Learn from their experiences and get mentored on your journey
          by folks from around the world.
        </p>
        <a href="https://www.youtube.com/playlist?list=PL9gnSGHSqcnqwmKYZ5rHuzqe32Di47KMr">
          <button className="podcast_redirect"> See all episodes </button>
        </a>
      </div>

      <img className="podcast_img" src={PodcastImg} alt="Podcast" />
    </div>
  );
};
