      ...
      <div className="footer-col2">
        ...
        <div className="footer-col2-2">
          ...
          <ul>
            ...
            <li>
              <a href="https://t.me/commclassroom" target="_blank">
                Telegram
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="https://github.com/commclassroom" target="_blank">
                GitHub
              </a>
            </li>
          </ul>
...
// attribution:<a href="https://storyset.com/business">Business illustrations by Storyset</a>;
