...
const Founder = () => {
  return (
    <div className="founder">
      ...
      <img className="founder_img" src={FounderImg} alt="Kunal" />
      <div className="founder_text">
        <h2 className="founder_heading">
          <span className="founder_span">Founder: </span>Kunal Kushwaha{" "}
        </h2>
        ...
        <div className="founder_socials">
          ...
          <a href="https://www.instagram.com/kunalsig/" target="_blank">
            <p className="founder-item">
