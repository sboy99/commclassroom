    ...
    >
      ...
      <div className="mt-2 flex items-center gap-x-4 gap-y-2 flex-wrap">
        <HashLink
          smooth
          to="/#courses"
          className="px-4 w-full md:w-fit text-center py-2 bg-sky-50 hover:bg-sky-100 transition-all duration-300 text-sky-500 font-medium capitalize text-lg rounded-md"
        >
          See Courses
        </HashLink>
        <a
